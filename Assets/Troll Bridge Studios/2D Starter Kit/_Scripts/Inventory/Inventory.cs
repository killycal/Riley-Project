...
namespace TrollBridge {
	...
	public class Inventory : MonoBehaviour 
	{
		...
		void Update()
		{
			...
			if (Input.GetKeyDown (inventoryKey) && Grid_Helper.setup.UICanvas.activeInHierarchy) {
		...
		public void OpenCloseInventory(){
			...
			if (inventoryPanel.activeInHierarchy) {
				...
				Grid_Helper.soundManager.PlaySound (inventoryCloseSound);
			} else {
				// Play the open sound.
				Grid_Helper.soundManager.PlaySound (inventoryOpenSound);
			}
